...
if has('vim_starting')
  set runtimepath+=~/.nvim/ " use .nvim on windows
...
nnoremap <leader>tl :colorscheme beauty256<cr>
" - nop
nnoremap Q <nop>
" - buffers
nnoremap <c-q> :q<cr>
...
endfun
"inoremap <s-tab> <c-r>=FindSimilar(1)<cr> " as au
" - visual mode
nnoremap vv <c-v>
...
fun! RRunTill()
  ...
  norm! Vgg
  exec "normal \<Plug>REDSendSelection"
  call winrestview(w)
endfun
fun! RFile()
  ...
  xmap <cr> <Plug>REDSendSelection
  imap <c-cr> <Plug>RSendLine
  nmap gd <Plug>RHelp
  nmap <leader>rs <Plug>RObjectStr
  nmap <leader>rp <Plug>RObjectPr
...
nnoremap <leader>tt :NextColorScheme<cr>
...
" either ycm or ultisnips remap <tab> and <s-tab> somewhere => au
...
au BufNewFile,BufRead * inoremap <s-tab> <c-r>=FindSimilar(1)<cr>
